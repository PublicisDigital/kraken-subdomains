 ...
 * @param {Array} urls that should be bypassed
 */

module.exports = function (subdomains, directory, staticFolder, restrictedURLs) {
  ...
  return function (req, res, next) {
    ...
    if (_url.indexOf(subPath) > -1) {
      ...
      return;
    } else if (urlParts.length > 1 && restrictedURLs.indexOf(_url) < 0) {
